    ...
    return (
        <div>
            ...
            <section className='section_Pagin'>
                <h1 className=' text-center font-medium text-2xl'>Actualizar Producto</h1>
                    ...
                    <form className='contenedor px-11 py-2'>
                        <div class="space-y-3">
                            ...
                            <div class="border-b border-gray-900/10 pb-12">
                                <h2 class="text-base font-semibold leading-7 text-gray-900">Ingrese Los Datos del Producto</h2>
